# Getting help with blueprintr

Thanks for using blueprintr. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/blueprintr/issues) to make sure the 
